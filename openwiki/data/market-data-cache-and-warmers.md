...
- `tests/test_sources.py::TestSecretRedaction.test_cache_boundary_scrubs_any_producer_failure` verifies not-ok producer payloads are scrubbed before they are cached.
